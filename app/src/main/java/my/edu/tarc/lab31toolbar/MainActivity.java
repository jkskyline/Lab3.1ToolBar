...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewMessage=(TextView)findViewById(R.id.textViewMeassage);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            }else
            {
                ...
                Toast.makeText(getApplicationContext(),"This is the maximum size",Toast.LENGTH_SHORT).show();
            }
            ...
            {
                //getApplicationContext == this
                Toast.makeText(getApplicationContext(),"This is the minimum size",Toast.LENGTH_SHORT).show();
            }
